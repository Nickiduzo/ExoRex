...
public class NovaciteMaterial : MonoBehaviour
{
    private readonly int titaniumCost = 100;
    private readonly int ederiumCost = 48;
    private readonly int quartexCost = 25;
    private readonly int nexitCost = 5; 

    private int currentTitaniumCost = 1;
    private int currentEderiumCost = 1;
    private int currentQuartexCost = 1;
    private int currentNexitCost = 1;
    ...
    public void ProcureMaterial()
    {
            ...
            itemConfig.Titanium.amount >= currentTitaniumCost)
        {
            ...
            itemConfig.Nexit.amount -= currentNexitCost;
            itemConfig.Novacite.amount += 1;
    ...
    private void UpdateMaterial()
    {
        ...
        nexitAmount.text = currentNexitCost.ToString();
        UpdateButtonColor();
    }
